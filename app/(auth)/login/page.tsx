      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-10 opacity-0 animate-fade-in">
          ...
          <p className="text-text-secondary text-sm">
            Monitor your services. Stay informed.
          </p>
        </div>
        ...
        >
          ...
          <form action={formAction} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-3 px-4 bg-accent text-bg-primary font-medium rounded-lg transition-all duration-200 hover:bg-accent-hover disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
            >
